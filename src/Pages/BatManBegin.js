...
const BatManBegin = () => {
  ...
  return (
    ...
    <div className="header-thumbnail-image" style={{backgroundImage:`url('../Images/Bat.jpg')`}}>
    </div>
    <h1 className="header-title"><h4>Batman Begins</h4></h1>
    ...
    <a href="/category/science-fiction" className="info-title-link">Science fiction, Adventure</a>
    </div>
    <div className="info-block">
    ...
    <p className="header-short-description" style={{color:'white'}}>After witnessing his parents' death, Bruce learns the art of fighting to confront injustice. When he returns to Gotham as Batman, he decides to stop a secret society that intends to destroy the city.
    </p>
    ...
    <div className="header-info-title">Christopher Nolan
    </div>
    </div>
          </div>
        </div>
      ...
      <iframe width="800" height="450" src="https://www.youtube.com/embed/neY2xVmOfUM?si=VjsU12In7BMGHmUZ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
    <h2><u>TOP CAST</u></h2>
