...
const Dhoni = () => {
  ...
  return (
    ...
    <div className="header-thumbnail-image" style={{backgroundImage:`url('../Images/Ms.jpg')`}}>
    </div>
    <h1 className="header-title">M.S.Dhoni:<h6>The Untold Story</h6>
    </h1>
    ...
    <a href="/category/science-fiction" className="info-title-link">Biographical sports drama</a>
    </div>
    <div className="info-block">
    ...
    <p className="header-short-description" style={{color:'white'}}>The Untold Story is a 2016 Indian Hindi-language biographical sports drama film written and directed by Neeraj Pandey. It is based on the life of former Test, ODI and T20I captain of the Indian national cricket team, Mahendra Singh Dhoni.

    </p>
    <div className="header-info-block" style={{color:'white'}}>
    <div className="header-info-item">
    <div className="header-info-title bold">Duration:</div>
    <div className="header-info-title">3h 10 m
    </div>
    </div>
    <div className="header-info-item">
    <div className="header-info-title bold">Director:</div>
    <div className="header-info-title">Neeraj Pandey 
    </div>
    </div>
          </div>
        </div>
      ...
      <iframe width="800" height="450" src="https://www.youtube.com/embed/6L6XqWoS8tw?si=cwq5qQ9j2OSNbrNH" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
    <h2><u>TOP CAST</u></h2>
