...
const Jailer = () => {
  ...
  return (
    ...
    <div className="header-thumbnail-image" style={{backgroundImage:`url('../Images/jailer.jpg')`}}>
    </div>
    <h1 className="header-title">Jailer
    </h1>
    ...
    <a href="/category/science-fiction" className="info-title-link">Action Comedy</a>
    </div>
    <div className="info-block">
    ...
    <div className="header-info-title">Nelson Dilipkumar
      ...
      <iframe width="800" height="450" src="https://www.youtube.com/embed/Y5BeWdODPqo?si=JFVOmLjOg5v2VERr" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
    <h2><u>TOP CAST</u></h2>
